...
> ⚠️ **ملاحظة مهمة**: نسخة سطح المكتب من التطبيق غير متاحة حالياً بسبب بعض المشاكل التقنية. نحن نعمل على إصلاح هذه المشكلات وسيتم إطلاق النسخة قريباً. يمكنك متابعة التحديثات من خلال قسم [Issues](../../issues).

تطبيق لترجمة الروايات باستخدام الذكاء الاصطناعي.

## 🌟 المميزات المخطط لها

- ترجمة متقدمة باستخدام نماذج الذكاء الاصطناعي
- دعم متعدد اللغات
...
```bash
npm run dev  # لتشغيل واجهة المستخدم فقط
```

## 🚧 حالة المشروع

المشروع حالياً في مرحلة التطوير المبكر. النسخة الحالية تحتوي على:

- ✅ هيكل المشروع الأساسي
- ✅ إعداد بيئة التطوير
- ✅ تكوين الأدوات والتبعيات
- ❌ نسخة سطح المكتب (قيد الإصلاح)
...
- نسخة سطح المكتب غير متاحة حالياً
- بعض المشاكل في تكامل Tauri
- تحسينات مطلوبة في الأداء

## 🔜 التحديثات القادمة

- إصلاح مشاكل نسخة سطح المكتب
- تحسين واجهة المستخدم
- إضافة المزيد من خيارات الترجمة
- دعم المزيد من التنسيقات

## 📞 التواصل

إذا كان لديك أي استفسارات أو اقتراحات، يرجى فتح issue في هذا المستودع.
...
> ⚠️ **Important Note**: The desktop version of the application is currently unavailable due to technical issues. We are working on fixing these issues and will release the version soon. You can follow updates in the [Issues](../../issues) section.

This is an AI-powered novel translation application. The project is currently under early development, and the desktop version is temporarily unavailable. Please check back later for updates.
